...
class PflanzeRequests(HttpUser):
    """Lasttest für HTTP-Requests fuer Server Pflanze."""
    ...
    def get_id(self) -> None:
        """GET-Requests mit Pfadparameter: Pflanze-ID."""
        id_list: Final = [1, 20, 30, 40, 50, 60]
        for pflanze_id in id_list:
            self.client.get(f"/rest/{pflanze_id}")

    @task(200)
    def get_titel(self) -> None:
        """GET-Requests mit Query-Parameter: Teilstring des Pflanzetitels."""
