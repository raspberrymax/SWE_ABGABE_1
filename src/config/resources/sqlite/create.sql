...
CREATE INDEX IF NOT EXISTS pflanze_isbn_idx ON pflanze(isbn);

CREATE TABLE IF NOT EXISTS titel (
    id          INTEGER PRIMARY KEY AUTOINCREMENT,
    titel       TEXT NOT NULL,
    untertitel  TEXT,
    pflanze_id     INTEGER NOT NULL UNIQUE REFERENCES pflanze
);
...
CREATE INDEX IF NOT EXISTS abbildung_pflanze_id_idx ON abbildung(pflanze_id);
