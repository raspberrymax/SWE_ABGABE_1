    ...
    stages {
        ...
        stage('Init') {
            ...
            steps {
                ...
                git url: 'https://github.com/juergenzimmermann/pflanze', branch: 'main', poll: true
            }
        }
        ...
        stage('Install') {
            steps {
                ...
                // /var/jenkins_home/workspace/pflanze (siehe "pwd" oben)
                sh 'cat package.json'
        ...
        stage('Docker Image bauen') {
            steps {
                ...
                // def image = docker.build("juergenzimmermann/pflanze:${env.BUILD_ID}")
                // image.push()
                // image.push('latest')
            }
        }
